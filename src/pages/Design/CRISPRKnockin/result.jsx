...
import { executeKnockinDesign, getKnockinResult } from "@/utils/api/apis";
...
const KnockinResult = () => {
    ...
    const initializeData = async () => {
      try {
        ...
        const resolution = await resolveDesignResult({
          ...
          executeRequest: executeKnockinDesign,
          getRequest: getKnockinResult,
  ...
  return (
    <div className="knockin-result-container result-page-shell">
