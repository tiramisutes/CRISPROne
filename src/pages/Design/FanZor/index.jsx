      ...
      <div className="cas9-header">
        ...
        <div className="cas9-intro">
          ...
          <div style={{ lineHeight: 1.7, fontSize: "15px" }}>
            <p>
              <strong>FanZor</strong> is a eukaryotic RNA-guided nuclease system derived
              from transposon-associated elements. It represents a distinct class of
              programmable genome editing tools that function similarly to CRISPR systems
              but are evolutionarily independent.
            </p>
            <h3>🔑 Key Components</h3>
            <ul style={{ paddingLeft: "20px" }}>
              <li>
                <strong>Guide RNA:</strong> Contains a target-complementary region and
                structural elements required for FanZor activity
              </li>
              <li>
                <strong>Target Motif:</strong> Sequence constraint near the target site,
                analogous to PAM/TAM, varies across FanZor subtypes
              </li>
            </ul>
            <h3>⚙️ Design Workflow</h3>
            <ol style={{ paddingLeft: "45px" }}>
              <li>Select target genomic region (avoid repeats and low-complexity regions)</li>
              <li>Identify compatible target motifs</li>
              <li>Design guide sequence (18–24 nt, GC content 40–60%)</li>
              <li>Construct functional guide RNA structure</li>
              <li>Perform genome-wide off-target analysis</li>
              <li>Prioritize high-specificity candidates for validation</li>
            </ol>
          </div>
        </div>
      </div>
