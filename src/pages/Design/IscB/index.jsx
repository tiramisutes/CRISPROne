      ...
      <div className="cas9-header">
        ...
        <div className="cas9-intro">
          ...
          <div style={{ lineHeight: 1.7, fontSize: "15px" }}>
            <p>
              <strong>IscB</strong> is an ancestral RNA-guided nuclease closely related to
              CRISPR systems. It utilizes a structured RNA (often referred to as{" "}
              <strong>ωRNA</strong>) to recognize and cleave target DNA sequences, offering
              a compact alternative to Cas-based genome editing tools.
            </p>
            <h3>🔑 Key Components</h3>
            <ul>
              <li>
                <strong>ωRNA:</strong> Contains a guide region (~20 nt) and a conserved
                scaffold required for IscB binding
              </li>
              <li>
                <strong>TAM:</strong> Target Adjacent Motif required for recognition,
                typically short and often T-rich
              </li>
            </ul>
            <h3>⚙️ Design Workflow</h3>
            <ol style={{ paddingLeft: "45px" }}>
              <li>Select target region (avoid repetitive and highly polymorphic regions)</li>
              <li>Identify valid TAM motifs near the target site</li>
              <li>Design guide sequence (18–24 nt, GC content 40–60%)</li>
              <li>Assemble ωRNA (guide + scaffold structure)</li>
              <li>Perform genome-wide off-target analysis</li>
              <li>Select multiple candidate guides for validation</li>
            </ol>
          </div>
        </div>
      </div>
